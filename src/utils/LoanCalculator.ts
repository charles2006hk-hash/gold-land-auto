...
// 1. 新車 HP 佣金表
export const OCBC_NEW_HP: Record<string, number[]> = {
...
// 3. 二手車 HP 佣金表
export const OCBC_USED_HP: Record<string, number[]> = {
...
export const calculateAutoLoan = (
    ...
    else if (isUsedCar && financeType === 'HP') activeTable = table_used_hp;
    else if (isUsedCar && financeType === 'Lease') activeTable = table_used_lease;
