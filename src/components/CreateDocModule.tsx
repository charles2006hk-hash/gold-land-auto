                                            ...
                                            <table className="w-full text-[10px] border-collapse border border-slate-300 h-[72px]">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td className="border p-1 font-mono font-bold w-[34%] text-[10px]">{formData.regMark || 'TBC'}</td>
                                                        <td className="border p-1 bg-slate-50 font-bold w-[16%]">Make/Model</td>
                                                        <td className="border p-1 w-[34%] text-[10px] font-bold">{formData.make} {formData.model}</td>
                                                    </tr>
                                                    <tr>
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-4">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="p-3 bg-white rounded-xl border border-slate-300 shadow-sm">
                                <div className="text-[10px] font-bold text-slate-600 mb-3 uppercase tracking-wider">隨車附件與備註</div>
                                <div className="grid grid-cols-2 gap-3 mb-3 bg-slate-50 p-2 rounded-lg border border-slate-100">
                                    <label className="flex items-center text-xs font-bold text-slate-700 cursor-pointer"><input type="checkbox" checked={checklist.vrd} onChange={e=>setChecklist((prev: any)=>({...prev, vrd: e.target.checked}))} className="mr-2 accent-blue-600 w-4 h-4"/> 牌薄 (VRD)</label>
                                    <label className="flex items-center text-xs font-bold text-slate-700 cursor-pointer"><input type="checkbox" checked={checklist.keys} onChange={e=>setChecklist((prev: any)=>({...prev, keys: e.target.checked}))} className="mr-2 accent-blue-600 w-4 h-4"/> 後備匙</label>
                                    <label className="flex items-center text-xs font-bold text-slate-700 cursor-pointer"><input type="checkbox" checked={checklist.tools} onChange={e=>setChecklist((prev: any)=>({...prev, tools: e.target.checked}))} className="mr-2 accent-blue-600 w-4 h-4"/> 工具</label>
                                    <label className="flex items-center text-xs font-bold text-slate-700 cursor-pointer"><input type="checkbox" checked={checklist.manual} onChange={e=>setChecklist((prev: any)=>({...prev, manual: e.target.checked}))} className="mr-2 accent-blue-600 w-4 h-4"/> 說明書</label>
                                </div>
