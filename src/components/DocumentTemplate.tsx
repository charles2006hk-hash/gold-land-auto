                            ...
                            <tbody>
                                ...
                                {itemsToRender.map((item: any, idx: number) => (
                                    <tr key={`add-${idx}`} className="text-slate-600">
                                        <td className="border p-1.5 pl-4">+ {item.desc} {item.isFree ? '(F.O.C.)' : ''}</td>
                                        <td className="border p-1.5 text-right font-mono">{item.isFree ? '0' : formatCurrency(item.amount)}</td>
                                    </tr>
                                ))}
